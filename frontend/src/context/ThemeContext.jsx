...
export const themes = {
  dark: {
    ...
    pearl: {
    name: 'Pearl', emoji: '☀️',
    preview: ['#f0f0f0', '#c8102e', '#0d1117'],
    vars: {
        '--bg':            '#ebebeb',        // gris neutro → cards blancas resaltan
        '--bg-mid':        '#e0e0e0',
    ...
    vars: {
        '--bg':            '#dde3ea',        // más oscuro → cards blancas contrastan
        '--bg-mid':        '#cfd6df',        // idem
        '--glass-bg':      'rgba(255,255,255,0.92)',  // cards casi blancas puras
